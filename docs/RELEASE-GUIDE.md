...
플레이스토어/앱스토어 출시와 이후 업데이트 운영을 위한 핵심 가이드.

> 프로젝트 소개는 [README](../README.md), 코드 변경 이력은 [Log.md](../Log.md),
> 디자인 토큰은 [Design2.md](../Design2.md),
> 윈도우에서의 Play Store 빌드 절차는 [HANDOFF-WINDOWS.md](../HANDOFF-WINDOWS.md) 를 참고.

> ⚠️ 3장의 서명키 정보는 2026-08-29 에 교체되었다. 현재 키는
> `C:/Users/user/keystores/church-memory-2026.jks` (별칭 `key0`) 이며,
> 자세한 경위는 [Log.md](../Log.md) 23장을 볼 것.
