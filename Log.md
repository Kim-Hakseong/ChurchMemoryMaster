...
## 25. Apple 개인→조직 전환 시도와 좌초 (2026-08-27 ~ 09-02)
...
- [ ] 취소 회신 후 **인증서·식별자·프로파일 포털이 다시 열리는지** 확인
      (안 풀리면 Neil 에게 재촉 회신). 이게 열려야 iOS 빌드 가능
- [ ] 계정 페이지 `등록 유형: 개인` 유지 확인

---

**문서 갱신**: 2026-09-02
**작성**: Claude Code 세션 (Apple 조직 전환 시도·좌초 정리)
